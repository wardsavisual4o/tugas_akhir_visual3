...
zqry.SQL.Add('insert into pelanggan values(null,"'+edt1.Text+'","'+edt2.Text+'","'+edt3.Text+'")');
zqry.ExecSQL ;

zqry.SQL.Clear;
zqry.SQL.Add('select * from pelanggan');
zqry.Open;
...
zqry.SQL.Clear;
zqry.SQL.Add('Update pelanggan set Nama_pelanggan= "'+edt1.Text+'",Alamat="'+edt2.Text+'",No_telp="'+edt3.Text+'" where ID_pelanggan="'+id+'"');
zqry. ExecSQL;
...
begin
 zqry.SQL.Clear;
zqry.SQL.Add(' delete from pelanggan where ID_pelanggan="'+id+'"');
zqry. ExecSQL;
zqry.SQL.Clear;
zqry.SQL.Add('select * from pelanggan');
zqry.Open;
